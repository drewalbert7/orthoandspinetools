/**
 * Points → level (max 150). Each level requires more total points than the last
 * (Helldivers-style rising curve). Uses total vote-based score (same as totalKarma).
 *
 * Keep in sync with `frontend/src/lib/pointsLevel.ts`.
 */
