              ...
              <>
                ...
                {user.isAdmin && (
                  <Link
                    ...
                    className={`touch-target hidden sm:inline-flex items-center rounded-md px-2.5 py-1.5 text-sm font-medium transition-colors ${
                      location.pathname === '/admin' && location.search.includes('tab=analytics')
