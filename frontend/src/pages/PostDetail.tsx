  ...
  const renderComment = (comment: Comment, depth = 0) => {
    ...
    return (
      <div
        ...
        className={`${depth > 0 ? 'ml-3 sm:ml-6 border-l-2 border-gray-200 pl-3 sm:pl-4' : ''}`}
      >
        <div className="mb-4">
          {/* Comment Header */}
          ...
          {/* Comment Content */}
          <MarkdownContent className="text-gray-800 mb-2 text-sm [overflow-wrap:anywhere]">{comment.content}</MarkdownContent>

          {/* Comment Actions */}
          <div className="flex flex-wrap items-center gap-2 text-xs">
            {/* Voting Section */}
            <div className="flex items-center bg-gray-50 border border-gray-200 rounded-md px-1 py-0.5">
              <button
                onClick={() => handleCommentVote(comment.id, 'upvote')}
                className={`touch-target p-1.5 rounded-md hover:bg-gray-200 transition-colors ${
        ...
        {replyingTo === comment.id && (
          <div className="bg-gray-50 border border-gray-200 rounded-md p-3 sm:p-4 mb-2 ml-0 sm:ml-8">
            <div className="mb-3">
              <textarea
                value={replyContent}
        ...
        <div className="flex-1">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-2 text-sm">
              ...
              {/* Comments */}
              <button className="flex items-center space-x-1 px-2 py-1.5 min-h-[36px] rounded-md border border-gray-200 hover:border-gray-300 bg-gray-50 hover:bg-gray-100 transition-colors">
                <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
